        ...
        <header className="header">
            ...
            <nav className="h-12 shadow text-sm bg-gray-800 text-gray-400 flex justify-between items-center px-5">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <p className="h-5 flex gap-1" ><img src="https://histudy.pixcelsthemes.com/livepreview/histudy/assets/images/icons/hand-emojji.svg" alt="" className="h-5" /><span>Intro price. Get Histudy for Big Sale -95% off.</span></p>
                </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative group py-4">
                            ...
                            <div className="absolute hidden group group-hover:block bg-white text-black shadow-lg rounded-md top-10 left-0 w-32 py-2 z-50">
                                <p className="px-4 py-2 hover:bg-gray-200 cursor-pointer"> <span>English</span> </p>
                                <p className="px-4 py-2 hover:bg-gray-200 cursor-pointer"> <span>Hindi</span></p>
                                <p className="px-4 py-2 hover:bg-gray-200 cursor-pointer"><span>Marathi</span></p>
                            </div>
                        </div>
            ...
            <nav className="bg-gray-100 w-full rel  transform duration-500  ease-in-out flex items-center justify-between  px-4 ">
                ...
                <nav className="  bg-gray-100  flex gap-8 items-center transform duration-500  ease-in-out ">
                    <ul className={isMenuOpen ? "show" : "flex gap-3 font-bold"}>
                        <div className="group ">
                            <li className="flex justify-center items-center gap-1 group-hover:text-blue-500  py-5"><a href="#home" className="group-hover:text-blue-500 ">Home</a>     <FaChevronUp className="group-hover:rotate-180 transition duration-400" /></li>
                            <div className="absolute z-100 left-5 items-center place-items-center justify-center top-28 w-[90%]  bg-gray-800 text-white rounded-md shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all  duration-500 ease-in-out grid grid-cols-5  gap-4 p-5"  >
                                ...
                                <div className="relative cursor-pointer group transform transition-transform duration-300 ease-in-out hover:-translate-y-2 group1">
                                    ...
                                    <div className="bg-amber-900 h-32 w-50 rounded-2xl  ">
                        ...
                        <div className="group">
                            ...
                            <li className="flex justify-center items-center py-5 gap-1 group-hover:text-blue-500"><a href="#courses" className="group-hover:text-blue-500">Courses</a><FaChevronUp className="group-hover:rotate-180 transition duration-400" /></li>
                                ...
                                <div className="w-full  bg-black h-30 navbar-banner  ">
                                    ...
                                    <div className="w-120 relative text-gray-50 flex flex-col justify-center ">
                                        <div className="flex">
                                            ...
                                            <div className="bg-black w-30 h-30">

                                            </div>
                                            <div className="bg-gradient-to-r h-30   from-black to-transparent w-50 p-2 text-gray-50 flex flex-col justify-center ">
                                        ...
                                        <div className="absolute">
                                            ...
                                            <p className="font-normal ml-5">Start building fast, with code samples, key </p>
                                    ...
                                    <div className=" bg-white text-gray-600 flex gap-10 pb-6">
                                        ...
                                        <div className=" w-1/2 ml-5 mt-8 ">
                                            ...
                                            <p className=" hover:text-blue-600 cursor-pointer hover:bg-gray-300 transition duration-300 ease-in p-2 px-3 rounded">Filter One Toggle</p>
                                            <p className=" hover:text-blue-600 cursor-pointer hover:bg-gray-300 transition duration-300 ease-in p-2 px-3 rounded">Filter One Toggle</p>
                                            <p className=" hover:text-blue-600 cursor-pointer hover:bg-gray-300 transition duration-300 ease-in p-2 px-3 rounded">Filter One Toggle</p>
                                            <p className=" hover:text-blue-600 cursor-pointer hover:bg-gray-300 transition duration-300 ease-in p-2 px-3 rounded">Filter One Toggle</p>
                                            <p className=" hover:text-blue-600 cursor-pointer hover:bg-gray-300 transition duration-300 ease-in p-2 px-3 rounded">Filter One Toggle</p>
                        ...
                        <div className="group">
                            ...
                            <li className="flex justify-center items-center py-5 gap-1 group-hover:text-blue-500"><a href="#courses" className="">Pages</a><FaChevronUp className="group-hover:rotate-180 transition duration-400" /></li>
                                ...
                                <div className="w-full  bg-black h-30 navbar-banner  ">
                                    ...
                                    <div className=" bg-white text-gray-600 flex gap-10 pb-6">
                                        ...
                                        <div className="w-1/2 mt-8 mr-5 ">
                                            ...
                                            <div className=" bg-gray-300 h-20 w-60 rounded-t-xl">

                                            </div>
                                            <div className=" bg-gray-100 h-20 w-60 ">
                                            ...
                                            <div className=" bg-gray-300 h-20 w-60 rounded-b-xl">
                        ...
                        <div className="group">
                            ...
                            <li className="flex justify-center items-center py-5 gap-1 hover:text-blue-500"><a href="#courses" className="hover:text-blue-500">Element</a><FaChevronUp className="group-hover:rotate-180 transition duration-400" /></li>
                        ...
                        <div className="group">
                            ...
                            <li className="flex justify-center items-center py-5 gap-1 hover:text-blue-500"><a href="#courses" className="hover:text-blue-500">Pages</a><FaChevronUp className="group-hover:rotate-180 transition duration-400" /></li>
                                ...
                                <div className="w-full  bg-black h-30 navbar-banner   ">
                                    ...
                                    <div className=" bg-white text-gray-600 flex gap-10 pb-6">
                                        ...
                                        <div className="w-1/2 mt-8 mr-5 ">
                                            ...
                                            <div className=" bg-gray-300 h-80 w-60 rounded">
